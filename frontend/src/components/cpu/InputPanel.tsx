...
const InputPanel: React.FC<InputPanelProps> = ({
    ...
    return (
        <div className="bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-lg p-6 shadow-sm dark:shadow-none">
            <div className="flex items-center justify-between mb-4">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 text-sm bg-zinc-100 dark:bg-zinc-700 hover:bg-zinc-200 dark:hover:bg-zinc-600 text-gray-700 dark:text-gray-200 rounded-lg transition-colors"
                >
                ...
                <table className="w-full text-sm">
                    ...
                    <tbody>
                        {processes.map((process, index) => (
                            <tr key={process.id} className="border-b border-zinc-100 dark:border-zinc-700/50 hover:bg-zinc-50 dark:hover:bg-zinc-700/30 transition-colors">
                                <td className="py-3 px-4">
                                    <input
                                        type="text"
                                        value={process.name}
                                        onChange={(e) => handleProcessChange(index, 'name', e.target.value)}
                                        className="w-20 bg-zinc-50 dark:bg-zinc-700 border border-zinc-300 dark:border-zinc-600 rounded px-3 py-1.5 text-gray-800 dark:text-gray-200 focus:outline-none focus:border-primary-500 transition-colors"
                                    />
                                </td>
                                <td className="py-3 px-4">
                                    <input
                                        ...
                                        className="w-24 bg-zinc-50 dark:bg-zinc-700 border border-zinc-300 dark:border-zinc-600 rounded px-3 py-1.5 text-gray-800 dark:text-gray-200 focus:outline-none focus:border-primary-500 transition-colors"
                                    />
                                </td>
                                <td className="py-3 px-4">
                                    <input
                                ...
                                <td className="py-3 px-4 text-center">
                                    <button
                                        ...
                                        className="px-3 py-1 text-xs bg-red-600 hover:bg-red-700 disabled:bg-zinc-200 dark:disabled:bg-zinc-700 disabled:text-gray-400 dark:disabled:text-gray-500 disabled:cursor-not-allowed text-white rounded transition-colors"
                                    >
                                        Remove
                                    </button>
                                </td>
