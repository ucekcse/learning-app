                    ...
                    <div key={step.step} className="border-l-4 border-primary-500 pl-3 sm:pl-6 py-2">
                        <div className="flex items-start gap-2 sm:gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                                <h3 className="text-base sm:text-lg font-semibold text-gray-100 mb-1 sm:mb-2">{step.title}</h3>
                                <p className="text-gray-300 mb-2 sm:mb-3 text-sm sm:text-base break-words">{step.description}</p>
                                ...
                                {step.variables && step.variables.length > 0 && (
                                    <div className="bg-dark-elevated rounded-lg p-3 sm:p-4 mb-2 sm:mb-3 overflow-hidden">
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            <span className="text-xs sm:text-sm font-semibold text-gray-200">Variables Used:</span>
                                        </div>
                                        <div className="space-y-1 sm:space-y-2">
                                            {step.variables.map((variable, idx) => (
                                                <div key={idx} className="text-xs sm:text-sm break-words">
                                                    <code className="text-primary-400 text-xs">{variable.name}</code>
                                ...
                                {step.codeSnippet && (
                                    <pre className="bg-dark-bg border border-dark-border rounded-lg p-3 sm:p-4 overflow-x-auto scrollbar-thin">
                                        <code className="text-xs sm:text-sm text-gray-300 whitespace-pre-wrap break-all sm:break-normal sm:whitespace-pre">{step.codeSnippet}</code>
                                    </pre>
                                )}
                            </div>
                        </div>
