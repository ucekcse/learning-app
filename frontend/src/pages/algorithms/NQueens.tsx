...
const NQueens: React.FC = () => {
  ...
  const algorithmData: AlgorithmData = {
    ...
    definition:
      "The N-Queens problem is a classic backtracking problem where the goal is to place N chess queens on an N×N chessboard so that no two queens threaten each other.",
    realWorldUse:
      "Constraint satisfaction problems, scheduling, resource allocation, circuit board design.",
    pros: [
    ...
    workingSteps: [
      {
        ...
        description:
          "Begin with an empty board and try to place a queen in the first row.",
      ...
      },
      {
        ...
        title: "Try Columns",
        description:
          "Iterate through all columns in the current row. Check if placing a queen is safe.",
      ...
      },
      {
        ...
        description:
          "If safe, place queen and move to next row. If next row returns False, backtrack (remove queen) and try next column.",
        codeSnippet:
          "board[row] = col; if solve(row+1): return True; board[row] = -1;",
      },
    ],
    defaultInputs,
    ...
    <div className="min-h-screen bg-surface-50 dark:bg-dark-950 text-gray-900 dark:text-white p-3 sm:p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="card">
          ...
          <span className="algorithm-badge badge-sorting">
        ...
        <div className="card">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-6">
            Chessboard showing queen placements for the {inputs.n}-Queens
            problem.
          </p>
