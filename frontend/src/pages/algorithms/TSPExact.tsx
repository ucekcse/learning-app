...
const TSPExact: React.FC = () => {
  ...
  const solveTSP = async () => {
    ...
    const permute = async (arr: number[], m: number[] = []) => {
      ...
      if (arr.length === 0) {
        ...
        setCurrentEdge({
          from: fullPath[fullPath.length - 1],
          to: fullPath[0],
        });
        await sleep(20);
  ...
  const algorithmData: AlgorithmData = {
    ...
    realWorldUse:
      "Route planning for logistics/delivery, circuit board drilling, DNA sequencing, telescope scheduling.",
    pros: [
    ...
    workingSteps: [
      {
        ...
        description:
          "Create a matrix representing distances between every pair of cities.",
      ...
      },
      {
        ...
        description:
          "Use a recursive approach with memoization. The state is defined by (mask, current_city), where mask represents the set of visited cities.",
        codeSnippet:
      ...
      },
      {
        ...
        description:
          "Backtrack effectively to find the sequence of cities that led to the minimum cost.",
      },
    ],
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="card">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">
            Brute force visualization for small N (checks all permutations).
          </p>

          <div className="flex gap-4 mb-4">
            <button
              onClick={() => generateCities(5)}
