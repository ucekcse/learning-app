...
const KthSmallest: React.FC = () => {
  ...
  const [message, setMessage] = useState(
    "Click Play to start QuickSelect algorithm",
  );
  ...
  const algorithmData: AlgorithmData = {
    ...
    definition:
      "The Kth Smallest Element algorithm finds the k-th smallest element in an unordered list. While sorting the list takes O(N log N), this can be solved more efficiently using QuickSelect (similar to QuickSort) in O(N) average time.",
    realWorldUse:
      "Median finding, order statistics, deciles/percentiles in data analysis.",
    pros: [
    ...
    workingSteps: [
      {
        ...
        title: "Choose Pivot",
        description:
          "Select a pivot element (e.g., last element, random element, or median-of-medians).",
      ...
      },
      {
        ...
        title: "Partition",
        description:
          "Rearrange the array such that elements smaller than pivot are on the left, and elements greater are on the right.",
      ...
      },
      {
        ...
        description:
          "If the pivot index matches k-1, we found the element. If it is greater than k-1, recurse on the left subarray. Otherwise, recurse on the right.",
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="card">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-4">
            QuickSelect Visualization (Partitioning logic).
          </p>
