...
const FCFS: React.FC = () => {
  ...
  const algorithmData: AlgorithmData = {
    ...
    definition:
      "First Come First Served (FCFS) is the simplest CPU scheduling algorithm where processes are executed in the order they arrive in the ready queue. The process that requests the CPU first is allocated the CPU first. It is a non-preemptive scheduling algorithm, meaning once a process starts execution, it runs to completion.",
    realWorldUse:
      "FCFS is used in batch processing systems, print job scheduling, ticket booking systems (first come first served basis), and simple embedded systems where fairness and simplicity are more important than efficiency. It's also used in scenarios where all processes have similar execution times.",
    pros: [
    ...
    workingSteps: [
      {
        ...
        description:
          "Processes arrive and are put in a line (Ready Queue), just like people waiting in a queue to buy tickets.",
        variables: [
          {
            name: "processes",
            type: "list",
            purpose: "List of waiting processes",
          },
          {
            name: "ready_queue",
            type: "queue",
            purpose: "Line of processes waiting for CPU",
          },
        ],
      ...
      },
      {
        ...
        description:
          "The CPU selects the process at the front of the line. It runs this process until it is completely finished.",
        variables: [
          { name: "current_time", type: "int", purpose: "Current clock time" },
          {
            name: "running_process",
            type: "Process",
            purpose: "Process currently using the CPU",
          },
        ],
        codeSnippet:
      ...
      },
      {
        ...
        description:
          "After the process finishes, we calculate how long it waited (Waiting Time) and total time spent (Turnaround Time).",
        variables: [
          {
            name: "waiting_time",
            type: "int",
            purpose: "start_time - arrival_time",
          },
          {
            name: "turnaround_time",
            type: "int",
            purpose: "completion_time - arrival_time",
          },
        ],
        codeSnippet:
      ...
      },
      {
        ...
        title: "Next Process",
        description:
          "The CPU moves to the next process in line. This repeats until everyone is served.",
    ...
    examples: [
      {
        ...
        explanation:
          "P1 arrives first at time 0 and executes from 0-4. P2 arrives at 1 but waits until P1 completes, executing from 4-7 (waiting time = 3). P3 arrives at 2, waits until 7, executes from 7-8 (waiting time = 5). P4 arrives at 3, waits until 8, executes from 8-10 (waiting time = 5). Average waiting time = (0+3+5+5)/4 = 3.25.",
      },
    ],
  };
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="card">
          <div className="flex items-center justify-between">
            <div>
              ...
              <span className="algorithm-badge badge-cpu">
        ...
        <InputPanel
          ...
          onProcessesChange={(newProcesses) =>
            setInputs({ processes: newProcesses })
          }
          algorithmType="fcfs"
        />
        ...
        <div className="card">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Watch how FCFS schedules processes in arrival order with the Gantt
